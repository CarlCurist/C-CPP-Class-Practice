...
Hero::Hero():Entity()
{
	...
	this->setText("resources/image/shoot.png",0,99,102,126);
	crashTexture1.loadFromFile("resources/image/shoot.png",sf::IntRect(165, 234, 102, 126));
	crashTexture2.loadFromFile("resources/image/shoot.png",sf::IntRect(330, 498, 102, 126));
	crashTexture3.loadFromFile("resources/image/shoot.png",sf::IntRect(432, 624, 102, 126));
