...
Enemy::Enemy(int type):Entity()
{
    if(type==elite)
    {
        this->setText("resources/image/shoot.png",0,0,69,95);
    ...
    if(type==normal)
    {
        this->setText("resources/image/shoot.png",534,612,57,43);
        this->setTexture(*(getText()));
    ...
    if(type==boss)
    {
        this->setText("resources/image/shoot.png",166,750,169,258);
        this->setTexture(*(getText()));
